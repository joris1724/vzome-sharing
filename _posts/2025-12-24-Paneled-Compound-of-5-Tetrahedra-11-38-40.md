...
<br> the geometry of the connectors at the vertices of the panel,
<br> the physical aspects of the struts at the edges (in this case, 2 b0's, 2 g0's and one 1 g1),
<br> the dihedral angles of the neighboring panels.
It is assumed the <a href="https://joris1724.github.io/vzome-sharing/2025/12/24/11-38-40-Paneled-Compound-of-5-Tetrahedra/connector.scad">connector.scad</a> has been made available first. For the present model, the 60 panels, all of the same shape, were printed using translucent PETG in 5 colors. The edges clamping the two b0 struts apparently needed some support. For this, I used PLA. The resulting panels could be inserted into the model, without any need for post-processing.

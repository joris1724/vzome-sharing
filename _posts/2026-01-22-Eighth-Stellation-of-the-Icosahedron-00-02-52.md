...
description: Some vZome models cannot be realized with Zometool, as the would require the ability to put the tips of multiple struts into the same hole of a connector. This model shows a first technique, 3D printing of modified struts, to bypass this problem.

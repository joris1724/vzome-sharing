...
<p>
The hecatonicosachoron is build 2 strut lengths shorter (i.e., "2" -> "0"), around the same center as the hexacosichoron. White connectors belong to the hecatonicosachoron, black to the hexacosichoron, grey to both of them. Each teal ball connects two hb1 and two hb3 struts. You could replace this by bending a b2 over a b0, which I do not like.

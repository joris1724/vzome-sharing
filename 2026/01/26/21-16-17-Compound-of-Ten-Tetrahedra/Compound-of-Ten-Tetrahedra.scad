...
module tubesector(r,x0,y0,z0,frac,rot) {
    ...
    rotate([0,0,rot]) scale(1/sc) difference() {
        linear_extrude(sqrt(x0*x0+y0*y0+z0*z0)) circle(r,$fn=64);
        linear_extrude(sqrt(x0*x0+y0*y0+z0*z0)) translate([2*r*frac,0,0]) square(2*r,center=true);
    }

}

scale(sc) rotate([159.094843,0,0]) difference() {
render() {
    triangle(0,0,2,1,4,4,8.6,8.6,true,false,true,2+70.53/2,0,2+70.53/2);
    triangle(1,8,11,26,4,4,8.6,0.6,true,true,false,2+41.81/2,0,0);
    scale(sc) tubesector(4.3/sc,6.8541,-4.9597,-1.8944,0.51,126);      
    } 
render() {
    ...
    polyhedron(points[1],faces=[[ 24, 22, 13, 20 ],[ 25, 23, 22, 24 ],[ 19, 21, 20, 13 ],[ 20, 21, 25, 24 ],[ 19, 13, 22, 23 ],[ 23, 25, 21, 19 ]]);
    polyhedron(points[1],faces=[[ 17, 19, 10 ],[ 16, 17, 15, 14 ],[ 10, 1, 5 ],[ 6, 12, 15, 3 ],[ 19, 13, 7, 1, 10 ],[ 16, 4, 7, 13 ],[ 1, 7, 4 ],[ 18, 14, 15 ],[ 4, 5, 1 ],[ 9, 2, 14 ],[ 0, 2, 9 ],[ 17, 5, 3, 15 ],[ 9, 14, 18 ],[ 19, 17, 16 ],[ 4, 16, 14, 2 ],[ 18, 15, 12 ],[ 19, 16, 13 ],[ 5, 4, 2, 3 ],[ 6, 3, 0 ],[ 3, 2, 0 ],[ 10, 5, 17 ],[ 0, 9, 18, 12, 6 ]]);
    polyhedron(points[0],faces=[[ 30, 25, 29 ],[ 23, 28, 30, 26, 21 ],[ 22, 21, 24 ],[ 24, 21, 26 ],[ 22, 23, 21 ],[ 29, 26, 30 ],[ 24, 29, 25, 27, 22 ],[ 27, 23, 22 ],[ 25, 28, 27 ],[ 27, 28, 23 ],[ 25, 30, 28 ],[ 29, 24, 26 ]]);
    polyhedron(points[0],faces=[[ 14, 17, 19 ],[ 15, 20, 18 ],[ 17, 18, 20, 3, 19 ],[ 13, 17, 14 ],[ 13, 15, 18 ],[ 17, 13, 18 ],[ 16, 14, 19 ],[ 16, 20, 15 ],[ 20, 16, 3 ],[ 3, 16, 19 ],[ 13, 14, 10, 9 ],[ 16, 15, 11, 12 ],[ 14, 16, 12, 10 ],[ 15, 13, 9, 11 ],[ 11, 9, 6 ],[ 8, 11, 6 ],[ 5, 9, 10 ],[ 10, 12, 7 ],[ 8, 12, 11 ],[ 5, 10, 7 ],[ 9, 4, 6 ],[ 12, 8, 7 ],[ 9, 5, 4 ],[ 4, 5, 7, 8, 6 ]]);
    } 
}
